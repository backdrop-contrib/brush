 ...
 */
class VariableCase extends Brush_TestCase {
  ...
  function testVariable() {
    ...
    $this->brush('variable-set', array('date_default_timezone', 'US/Mountain'), $options);
    $this->brush('variable-get', array('date_default_timezone'), $options); // Wildcard get.
    ...
    $this->brush('variable-set', array('site_name', 'unish'), $options + array('always-set' => NULL));
    $this->brush('variable-get', array('site_name'), $options);
    $var_export = $this->getOutput();
    eval($var_export);
    $this->assertEquals('unish', $variables['site_name'], '--always-set option works as expected.');

    $this->brush('variable-delete', array('site_name'), $options);
